...
from gym_multi_robot.envs.tiling_pattern_game_alternative import DifferenceTilingPatternGame

# Important variables.
experiment_name = 'NEAT_reference_block_w_sum_diff'
num_steps = 3000
num_generations = 100
num_runs = 5
...
gym.register(
    ...
    kwargs={'env_storage_path': 'tiles11x11_block.pickle', 'game_cls': DifferenceTilingPatternGame}
)
