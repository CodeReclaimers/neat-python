...
---------------------------------------
To install the most recent release (version 0.9) from PyPI, you should run the command (as root or using `sudo`
as necessary)::
...
for release 0.9
<https://github.com/CodeReclaimers/neat-python/releases/tag/v0.9>`_ and use the example code contained in it.

You may also just download the 0.9 release source, and install it directly using `setup.py` (as shown below)
instead of `pip`.
...
or downloading the `source archive for release 0.9
