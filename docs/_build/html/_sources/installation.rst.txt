...
---------------------------------------
To install the most recent release (version 0.91) from PyPI, you should run the command (as root or using `sudo`
as necessary)::
...
for release 0.91
<https://github.com/CodeReclaimers/neat-python/releases/tag/v0.91>`_ and use the example code contained in it.

You may also just get the 0.91 release source, and install it directly using `setup.py` (as shown below)
instead of `pip`.
...
or downloading the `source archive for release 0.91
