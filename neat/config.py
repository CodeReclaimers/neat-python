...
def load(filename):
    try:
        ...
        Config.prob_deleteconn = float(parameters.get('genetic', 'prob_deleteconn'))
        # Config.prob_deletenode          = float(parameters.get('genetic','prob_deletenode'))
...
class Config:
    ...
    prob_addconn = None
    prob_addnode = None
    prob_deleteconn = None
    # prob_deletenode         = None
